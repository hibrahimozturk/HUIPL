...
\centering
	\textsc{\large Results for k=5;}\\[0.1 cm]  
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{rgb/bee_k_5.jpg}
		\end{figure}	
\end{minipage}
...
\centering
	\textsc{\large Results for k=10;}\\[0.1 cm]  
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{rgb/bee_k_10.jpg}
		\end{figure}
...
\centering
	\textsc{\large Results for k=15;}\\[0.1 cm]  
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{rgb/bee_k_15.jpg}
		\end{figure}
\end{minipage}
...
\centering
	\textsc{\large Results for k=5;}\\[0.1 cm]  
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{rgbxyz/bee_k_5.jpg}
		\end{figure}	
\end{minipage}
...
\centering
	\textsc{\large Results for k=10;}\\[0.1 cm]  
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{rgbxyz/bee_k_10.jpg}
		\end{figure}
...
\centering
	\textsc{\large Results for k=15;}\\[0.1 cm]  
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{rgbxyz/bee_k_15.jpg}
		\end{figure}
\end{minipage}
...
\centering
	...
	\begin{minipage}{0.45\linewidth}
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_5_500.jpg}
	 		\caption{superpixel level=500}
		\end{figure}
	\end{minipage}
	\hspace{0.05\linewidth}
	\begin{minipage}{0.45\linewidth}
			\begin{figure} [H]
				\centering
				 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_5_2000.jpg}
	 			\caption{superpixel level=2000}
			\end{figure}
	\end{minipage}
	\hspace{0.05\linewidth}
	\begin{minipage}{0.45\linewidth}
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_5_5000.jpg}
	 		\caption{superpixel level=5000}
		\end{figure}
	\end{minipage}
\end{minipage}
...
\centering
	...
	\begin{minipage}{0.45\linewidth}
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_10_500.jpg}
	 		\caption{superpixel level=500}
		\end{figure}
	\end{minipage}
	\hspace{0.05\linewidth}
	\begin{minipage}{0.45\linewidth}
			\begin{figure} [H]
				\centering
				 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_10_2000.jpg}
	 			\caption{superpixel level=2000}
			\end{figure}
	\end{minipage}
	\hspace{0.05\linewidth}
	\begin{minipage}{0.45\linewidth}
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_10_5000.jpg}
	 		\caption{superpixel level=5000}
		\end{figure}
	\end{minipage}
\end{minipage}
...
\centering
	...
	\begin{minipage}{0.45\linewidth}
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_15_500.jpg}
	 		\caption{superpixel level=500}
		\end{figure}
	\end{minipage}
	\hspace{0.05\linewidth}
	\begin{minipage}{0.45\linewidth}
			\begin{figure} [H]
				\centering
				 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_15_2000.jpg}
	 			\caption{superpixel level=2000}
			\end{figure}
	\end{minipage}
	\hspace{0.05\linewidth}
	\begin{minipage}{0.45\linewidth}
		\begin{figure} [H]
			\centering
			 \includegraphics[width=\linewidth]{superpixel_rgb_hist/bee_15_5000.jpg}
	 		\caption{superpixel level=5000}
		\end{figure}
	\end{minipage}
\end{minipage}
